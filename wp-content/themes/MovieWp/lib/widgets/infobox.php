...
$theme->options['widgets_options']['infobox'] = array_key_exists('infobox', $theme->options['widgets_options'])
...
class ThematerInfoBox extends WP_Widget 
{
    function __construct() 
    {
        ...
        parent::__construct('themater_infobox', '&raquo; Info Box', $widget_options, $control_options);
    }
