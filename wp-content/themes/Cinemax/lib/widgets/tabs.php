...
$theme->options['widgets_options']['tabs'] = array_key_exists('tabs', $theme->options['widgets_options'])
...
class ThematerTabs extends WP_Widget 
{
    ...
    function __construct() 
    {
        ...
        parent::__construct('themater_tabs', '&raquo; Tabs Widget', $widget_options, $control_options);
    }
