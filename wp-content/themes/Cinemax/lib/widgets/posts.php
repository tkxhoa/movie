...
$theme->options['widgets_options']['posts'] = array_key_exists('posts', $theme->options['widgets_options'])
...
class ThematerPosts extends WP_Widget 
{
    function __construct() 
    {
        ...
        parent::__construct('themater_posts', '&raquo; Posts with Images', $widget_options, $control_options);
    }
