...
$theme->options['widgets_options']['banners125'] = array_key_exists('banners125', $theme->options['widgets_options'])
...
class ThematerBanners125 extends WP_Widget 
{
    function __construct() 
    {
        ...
        parent::__construct('themater_banners_125', '&raquo; 125x125 Banners', $widget_options, $control_options);
    }
